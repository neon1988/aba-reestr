...
@section('content')
    ...
    <!-- Search Section -->
    <section class="py-12 bg-white" x-data="{ open: false }">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-semibold text-gray-900 mb-6">Поиск центров ABA</h2>
            <form action="{{ route('centers.index') }}" method="post" enctype="multipart/form-data" class="space-y-6">
                @csrf
                <!-- Простое поле поиска -->
                <div class="flex justify-center space-x-4">
                    <input name="search" value="{{ old('search') }}" type="text" placeholder="Поиск по названию или городу"
                    ...
                    <div x-on:click="open = ! open" class="cursor-pointer bg-cyan-600 text-white py-3 px-6 rounded-lg hover:bg-cyan-700 transition duration-300">
                        Расширенный поиск
                    </div>
                </div>

                <!-- Расширенный поиск -->
                <div class="bg-gray-100 p-6 rounded-lg mt-6" x-show="open">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4" >
                        ...
                        <div>
                            ...
                            <input name="address" value="{{ old('address') }}" id="address" type="text" placeholder="Введите адрес"
                                   class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500">
                        </div>
                        <div>
