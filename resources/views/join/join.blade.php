...
@section('content')
    ...
    <div class="max-w-6xl mx-auto p-3">
        ...
        <section class="bg-white p-3 lg:p-8 rounded-lg shadow-md mb-4">
            ...
            <p class="mt-6 text-md font-semibold mb-6">
                Присоединиться к подписке можно по одному из трех тарифов ниже:
            </p>
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-3 cursor-pointer">
                <!-- Card 1: Родители или смежники -->
                <a href="{{ route('yookassa.buy-subscription', ['type' => SubscriptionLevelEnum::ParentsAndRelated]) }}"
                ...
                <a href="{{ route('yookassa.buy-subscription', ['type' => SubscriptionLevelEnum::Specialists]) }}"
            ...
            <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
                ...
                <div class="space-y-3 sm:space-y-6">
                    ...
                    <div x-data="{ isOpen: false }">
                        ...
                        <div x-show="isOpen" class="p-4 bg-gray-50 rounded-lg mt-2">
                            ...
                            <ul class="list-disc pl-6 space-y-2">
                                ...
                                <li class="text-md">Родитель, родственник или опекун ребенка, подростка или молодого
                                    взрослого с аутизмом или другими нарушениями развития
                                </li>
                                <li class="text-md">Специалист в области специальной педагогики или психологии, который
                                    стремится к эффективным методам помощи своим подопечным
                                </li>
                    ...
                    <div x-data="{ isOpen: false }">
                        ...
                        <div x-show="isOpen" class="p-4 bg-gray-50 rounded-lg mt-2">
                            ...
                            <ul class="list-disc pl-6 space-y-2 text-md">
                                ...
                                <li>Для тарифов «B» и «C» потребуется отправить документы об образовании на проверку.
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div x-data="{ isOpen: false }">
                        <button @click="isOpen = !isOpen"
                                class="w-full text-left bg-white p-4 rounded-lg shadow-md hover:bg-gray-50 focus:outline-none">
                            <h5 class="text-xl font-semibold text-gray-900">Что делать в случае технических
                                проблем?</h5>
                        </button>
                        <div x-show="isOpen" class="p-4 bg-gray-50 rounded-lg mt-2">
                            <p class="text-md">
                                Если у вас возникли вопросы или технические неполадки,
                                <a class="text-cyan-600 hover:underline" href="{{ route('contacts') }}">напишите нам</a>,
                                мы поможем!
                            </p>
                        </div>
                    </div>
                        ...
                        <div x-show="isOpen" class="p-4 bg-gray-50 rounded-lg mt-2">
                            <ul class="list-disc pl-6 space-y-2">
                                <li class="text-md">
                                    ...
                                    <a class="text-cyan-600 hover:underline" href="{{ route('contacts') }}">связавшись с
                                        нами</a>.
                                </li>
                                <li class="text-md">
                                    Отменить подписку можно в любое время. Возврат осуществляется за неиспользованные
                                    дни.
                                </li>
                                <li class="text-md">
                                    Обратите внимание, что при годовой подписке вы оплачиваете 1 календарный месяц и
                                    получаете 11 месяцев доступа к сайту в подарок.
                                    Это условие прописано в <a class="text-cyan-600 hover:underline"
                                                               href="{{ route('contacts') }}">договоре оферты</a>.
                                </li>
                                <li class="text-md">
                                    Если вы не согласны с политикой возврата,
                                    <a class="text-cyan-600 hover:underline" href="{{ route('contacts') }}">свяжитесь с
                                        нами</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div x-data="{ isOpen: false }">
                        <button @click="isOpen = !isOpen"
                                class="w-full text-left bg-white p-4 rounded-lg shadow-md hover:bg-gray-50 focus:outline-none">
                            <h5 class="text-xl font-semibold text-gray-900">Как оставить отзыв, задать вопрос или
                                предложить улучшение?</h5>
                        </button>
                        <div x-show="isOpen" class="p-4 bg-gray-50 rounded-lg mt-2">
                            <p class="text-md">
                                Мы ценим ваше мнение!
                                <a class="text-cyan-600 hover:underline" href="{{ route('contacts') }}">Поделитесь
                                    отзывами, предложениями или вопросами</a>.
                            </p>
                        </div>
                    </div>
                </div>
