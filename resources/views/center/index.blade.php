        ...
        <div class="container mx-auto px-4">
            ...
            <form class="space-y-6">
                ...
                <div class="flex justify-center space-x-4">
                    <input type="text" placeholder="Поиск по названию или городу" class="w-1/3 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="bg-gray-100 p-6 rounded-lg mt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="legal_name" type="text" placeholder="Введите юридическое название" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label for="address" class="block text-gray-700">Адрес фактический</label>
                            <input id="address" type="text" placeholder="Введите адрес" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label for="tax_id" class="block text-gray-700">ИНН</label>
                            <input id="tax_id" type="text" placeholder="Введите ИНН" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div>
                            <label for="kpp" class="block text-gray-700">КПП</label>
                            <input id="kpp" type="text" placeholder="Введите КПП" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                    <button type="submit" class="bg-blue-600 text-white py-3 px-6 mt-6 rounded-lg hover:bg-blue-700 transition duration-300">Применить фильтры</button>
                </div>
            </form>
        </div>
    </section>
        ...
        <div class="container mx-auto text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300">
                    ...
                    <a href="/center/1" class="text-blue-600 hover:underline">Подробнее</a>
                </div>
                <!-- Center Card 2 -->
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300">
                    <img src="https://via.placeholder.com/400x250" alt="Фото центра" class="w-full h-48 object-cover rounded-lg mb-4">
                    ...
                    <a href="/center/2" class="text-blue-600 hover:underline">Подробнее</a>
                </div>
                <!-- Center Card 3 -->
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300">
                    <img src="https://via.placeholder.com/400x250" alt="Фото центра" class="w-full h-48 object-cover rounded-lg mb-4">
                    ...
                    <a href="/center/3" class="text-blue-600 hover:underline">Подробнее</a>
                </div>
            </div>
        </div>
    </section>
